/**
 * Land area unit conversion utility for the frontend.
 * Must match the backend unitUtils.js
 */
 ...
 */
export const convertArea = (amount, fromUnit, toUnit) => {
...
export const getAvailableUnits = () => Object.keys(UNIT_CONVERSIONS);
